...
We collect three facts already established in Lean:
\begin{itemize}
  \item $e(r,b)\ge 0$ for all $r,b$ (\texttt{zero\_le\_e});
  \item $r-b\le e(r,b)$ for all $r,b$ (\texttt{sub\_le\_e}), the inequality being
        read in $\mathbb Q$ after coercion;
  \item $e(n,n)>0$ for $n>0$ (\texttt{e\_pos\_of\_pos}).
\end{itemize}
