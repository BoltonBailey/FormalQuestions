...
\paragraph{The remaining gate.}
The only missing ingredient is the diagonal lower bound $e(r,r)\ge k\sqrt r$ (for
some fixed $k>0$). This is the genuine $\sqrt r$-diffusion fact; its natural proof
goes through the ballot/reflection estimate for the expected value of an explicit
stopping strategy, and is left as a separate development. Everything else in this
section is elementary and \texttt{sorry}-free.
